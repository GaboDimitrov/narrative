...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" ref={containerRef} className="py-32 relative overflow-hidden bg-dark-bg">
      {/* Background effects */}
      <div className="absolute top-1/4 -left-1/4 w-[500px] h-[500px] bg-primary-600/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 -right-1/4 w-[400px] h-[400px] bg-accent-pink/10 rounded-full blur-[100px]" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 text-primary-400 text-sm font-medium uppercase tracking-wider mb-4">
            How It Works
          </span>
        ...
        <div className="max-w-4xl mx-auto relative">
          {/* Progress Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-dark-border -translate-x-1/2 hidden md:block">
            <motion.div
              style={{ height: lineHeight }}
              className="w-full bg-gradient-to-b from-primary-500 to-accent-pink origin-top"
            />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex-1 ${isEven ? 'md:text-right' : 'md:text-left'}`}>
                    <div 
                      className={`rounded-2xl p-8 inline-block bg-dark-card/80 border border-dark-border backdrop-blur-sm hover:border-primary-500/50 transition-colors duration-300 ${
                  ...
                  <div className="relative hidden md:block">
                    ...
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-pink flex items-center justify-center shadow-glow z-10 relative">
                      <Icon />
                    </div>
                  </div>
